...
<img id="canvasImg" />
<video id="video1" src="https://statich.yidianzixun.com/public/file/1554204068231/centerVideo.mp4" autoplay></video>
</div>
</template>
  ...
  data () {
    return {
      ...
      option: {
        ...
        img: 'http://kss.ksyun.com/ks3/image_deal/suiyi.jpg',
        size: 1,
        full: false,
        outputType: 'png',
        canMove: true,
